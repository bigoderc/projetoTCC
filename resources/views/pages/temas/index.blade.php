        ...
        <div class="card">
            ...
            <div class="card-body">
                            ...
                            <div class="modal-content">
                                ...
                                <form id="addLinha" name="addLinha" enctype="multipart/form-data" class="needs-validation" novalidate>
                                    ...
                                    <div class="modal-body" class="my-2">
                                        ...
                                        <select class="form-control" id="fk_areas_id" name="fk_areas_id" aria-label="Default select example" required>
                ...
                <table id="my_table_id" class="text-center" data-toggle="table" data-editable="true" data-editable-pk="id" 
                    data-editable-mode="inline" data-editable-type="text" data-locale="pt-BR" data-search="true" data-show-columns="true" 
                    data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar" data-unique-id="id" data-id-field="id"
                    data-page-size="25" data-page-list="[5, 10, 25, 50, 100, all]" data-pagination="true" data-search-accent-neutralise="true" 
                    data-editable-url="#" data-url="{{ route('temas.show',1) }}">
                    <thead>
                        <tr>
            ...
            $("#addLinha").submit(function(event) {
                ...
                var validation = Array.prototype.filter.call(forms, function(form) {
                    if (form.checkValidity() === false) {
                        ...
                        $.ajax({
                            url: id > 0 ? `{{ url('temas/update/${id}') }}` : "{{ route('temas.store') }}",
                            type: "POST",
                            data: formdata,
                            dataType: "json",
                            processData: false,
